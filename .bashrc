...
alias v="vim";alias vi="vim";alias i3c="vim ~/.config/i3/config";bind -x '"\C-b": clear && printf "\e[3J"';export PROMPT_COMMAND=lastcmd;
function lastcmd () { 
local EXIT="$?"; PS1=""
local ecol='\[\e[0m\]';local rcol='\[\e[0;31m\]';local gcol='\[\e[1;32m\]';local ycol='\[\e[0;36m\]';local bcol='\[\e[0;34m\]';local pcol='\[\e[0;35m\]'
